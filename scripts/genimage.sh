...
apt update
apt install wget -y
wget https://github.com/droidian-sargo/linux-android-google-sargo/releases/download/images/boot.img
wget https://github.com/droidian-sargo/linux-android-google-sargo/releases/download/images/dtbo.img
wget https://github.com/droidian-sargo/linux-android-google-sargo/releases/download/images/vbmeta.img
